...
export const regPhoneNumber = /^1[23456789]\d{9}$/ // 手机
export const regTellNumber = /^([0-9-]+)$/ // 号码匹配-数字和横线
export const regPassword = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[a-zA-Z0-9]{6,16}$/ // 强密码(必须包含大小写字母和数字的组合，不能使用特殊字符，长度在 6-10 之间)
export const regNumber = /^[0-9]*$/ // 数字
export const regWebUrl = /^((https|http|ftp|rtsp|mms)?:\/\/)[^\s]+/ // 网址
export const checkCnZipCode = /^[0-9]{6}$/ // 国内邮编
export const regNum2Precision = /^[0-9]+(.[0-9]{1,2})?$/ // 数字精度为2
